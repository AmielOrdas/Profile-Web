...
export default function SubNavigation({
  ...
  return (
    <div
      className={clsx(
        "absolute top-full mt-3 max-h-40 overflow-y-auto text-white font-jetbrains text-[11px] transition-opacity duration-500 opacity-0 sm:group-hover/project:opacity-100 z-50 bg-transparent  focus:opacity-100 "
      )}
